...
tbool_t ap_ppl_poly_is_leq(ap_manager_t* man, PPL_Poly* a1, PPL_Poly* a2);
  /* Inclusion test */
  
tbool_t ap_ppl_poly_is_eq(ap_manager_t* man, PPL_Poly* a1, PPL_Poly* a2);
  /* Equality test */
...
tbool_t ap_ppl_poly_is_dimension_unconstrained(ap_manager_t* man, PPL_Poly* po,
					       ap_dim_t dim);
