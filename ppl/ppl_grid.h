...
tbool_t ap_ppl_grid_is_bottom(ap_manager_t* man, struct ppl_grid* a);
  /* Emptiness test */
tbool_t ap_ppl_grid_is_top(ap_manager_t* man, struct ppl_grid* a);
  /* Universe test */

tbool_t ap_ppl_grid_is_leq(ap_manager_t* man, struct ppl_grid* a1, struct ppl_grid* a2);
  /* Inclusion test */
  
tbool_t ap_ppl_grid_is_eq(ap_manager_t* man, struct ppl_grid* a1, struct ppl_grid* a2);
  /* Equality test */
 
tbool_t ap_ppl_grid_sat_lincons(ap_manager_t* man, struct ppl_grid* a, ap_lincons0_t* lincons);
  /* Satisfiability of a linear constraint */

tbool_t ap_ppl_grid_sat_interval(ap_manager_t* man, struct ppl_grid* a,
				 ap_dim_t dim, ap_interval_t* interval);
  /* Inclusion of a dimension in an interval */

tbool_t ap_ppl_grid_is_dimension_unconstrained(ap_manager_t* man, struct ppl_grid* po,
					       ap_dim_t dim);
