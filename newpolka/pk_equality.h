...
#ifndef __PK_EQUALITY_H__
#define __PK_EQUALITY_H__
...
void equality_approximate(ap_manager_t* man, poly_t* a, int algorithm);
  /* Perform some transformation on the abstract value, guided by the
     ...
     associated to equality_approximate (commodity feature). */

tbool_t equality_is_minimal(ap_manager_t* man, const poly_t* a);
tbool_t equality_is_canonical(ap_manager_t* man, const poly_t* a);
...
poly_t* equality_bottom(ap_manager_t* man, size_t intdim, size_t realdim);
  /* Create a bottom (empty) value */

poly_t* equality_top(ap_manager_t* man, size_t intdim, size_t realdim);
