...
void box_fdump(FILE* stream, ap_manager_t* man, const box_t* a);
...
tbool_t box_is_leq(ap_manager_t* man, const box_t* a1, const box_t* a2);
  /* inclusion check */

tbool_t box_is_eq(ap_manager_t* man, const box_t* a1, const box_t* a2);
  /* equality check */

tbool_t box_sat_lincons(ap_manager_t* man, const box_t* a, const ap_lincons0_t* cons);
...
box_t* box_forget_array(ap_manager_t* man,
			bool destructive,
			box_t* a, const ap_dim_t* tdim, size_t size,
			bool project);
