...
inline texpr1::builder neg(const texpr1::builder& a, ap_texpr_rtype_t rtype, ap_texpr_rdir_t rdir)
{
  return texpr1::builder(AP_TEXPR_NEG, a, rtype, rdir);
}

inline texpr1::builder cast(const texpr1::builder& a, ap_texpr_rtype_t rtype, ap_texpr_rdir_t rdir)
{
...
inline texpr1::builder sqrt(const texpr1::builder& a, ap_texpr_rtype_t rtype, ap_texpr_rdir_t rdir)
{
