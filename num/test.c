	   ...
	   double d)
{
  ...
  bound_set_infty(a);
  printf("bound_set_infty()="); bound_print(a); printf("\n");
...
int main(int argc, char**argv)
{
  ...
  mpz_init(mpz); mpq_init(mpq); mpq_init(mpq2); 
  ...
  
  {
    ...
    num(a,b,c,u,l,mpz,mpq,d);
    num(a,c,b,u,l,mpz,mpq,d);
...

  {
    ...
    bound(a,b,c,u,l,mpz,mpq,d);
    bound(a,c,b,u,l,mpz,mpq,d);
